...
//  - GoalForm requires a target date (GoalForm.svelte:41) — a DatePicker control
//    labelled {m.forms_target_date()}, set via the pickDate helper.
...
test('goals page loads and a goal can be created', async ({ onboardedPage: page }) => {
	...
	await pickDate(modal.getByLabel('Target date'), '2027-12-31');
