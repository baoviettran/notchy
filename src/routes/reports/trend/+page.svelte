<div class="space-y-6">
	...
	<div class="bg-white dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-6 text-center text-zinc-400 min-h-[300px] flex items-center justify-center">
		<p class="text-sm">Trend chart will appear here when you have transaction data.</p>
	</div>
</div>
