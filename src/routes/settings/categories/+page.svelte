				...
				{:else}
					{#each bucketTags as tag}
						<div class="p-3 flex items-center justify-between group">
							...
							<div class="flex gap-1 pointer-coarse:opacity-100 pointer-fine:opacity-0 pointer-fine:group-hover:opacity-100 pointer-fine:group-focus-within:opacity-100 transition-opacity">
